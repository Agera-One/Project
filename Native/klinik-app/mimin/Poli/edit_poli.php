...
// Ambil data poli
$query = mysqli_query($conn, "SELECT id, nama, status FROM poli WHERE id = $id LIMIT 1");
if (!$query || mysqli_num_rows($query) === 0) {
    $_SESSION['error_message'] = "Data poli tidak ditemukan!";
    header("Location: ../Poli/poli.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$nama) {
        ...
        // Cek duplikasi: apakah ada poli lain dengan nama yang sama?
        ...
        if (mysqli_num_rows($cek) > 0) {
            ...
            if ($update) {
                $_SESSION['success_message'] = "Data poliklinik berhasil diperbarui!";
                header("Location: ../Poli/poli.php");
                exit;
            } else {
...
<head>
    ...
    <title>Edit Poliklinik - Klinik Sehat</title>
        ...
        <div class="header-container">
            ...
            <div class="user-section">
                <div class="user-info">
                    ...
                    <div class="role"><?= ucfirst($_SESSION['role'] ?? 'Administrator') ?></div>
                </div>
    ...
    <main class="container">
        <div class="page-header">
            <div class="page-title">
                ...
                <div class="page-subtitle">Perbarui data poliklinik yang sudah terdaftar</div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h3>Perbarui Data Poliklinik</h3>
            </div>
            <form method="POST">
