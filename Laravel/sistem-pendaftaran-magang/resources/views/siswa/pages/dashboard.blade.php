...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="ml-[260px] p-[35px] bg-[#] flex-1 min-h-screen transition-margin duration-300 ease-in-out">
        <div class="main-content min-w-[1400px] mx-auto">
            <!-- STAT CARDS -->
            <div class="stat-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[35px] mb-[35px]">
    ...
    @include('siswa.pages.dashboardData')

    {{-- JS EKSTERNAL 100% BERSIH --}}
    <script src="{{ asset('assets/js/siswa/dashboard.js') }}?v={{ time() }}"></script>
</body>
